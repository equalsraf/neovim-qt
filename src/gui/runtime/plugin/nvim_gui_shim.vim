...
" Enable/Disable external GUI commandline 'ext_mdline'
function! s:GuiCommandline(enable) abort
	call rpcnotify(0, 'Gui', 'Option', 'Commandline', a:enable)
endfunction
command! -nargs=1 GuiCommandline call s:GuiCommandline(<args>)
