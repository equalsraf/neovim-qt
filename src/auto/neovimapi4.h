...
public slots:
	...
	// DEPRECATED
	// ArrayOf(String) buffer_get_line_slice(Buffer buffer, Integer start, Integer end, Boolean
	// include_start, Boolean include_end, )
	MsgpackRequest* buffer_get_line_slice(int64_t buffer, int64_t start, int64_t end,
										  bool include_start, bool include_end);
	// ArrayOf(String) nvim_buf_get_lines(Buffer buffer, Integer start, Integer end, Boolean
	// strict_indexing, )
	...
	// Boolean include_end, ArrayOf(String) replacement, )
	MsgpackRequest* buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end,
										  bool include_start, bool include_end,
										  QList<QByteArray> replacement);
	// void nvim_buf_set_lines(Buffer buffer, Integer start, Integer end, Boolean strict_indexing,
	// ArrayOf(String) replacement, )
	MsgpackRequest* nvim_buf_set_lines(int64_t buffer, int64_t start, int64_t end,
	...
	// Integer nvim_buf_add_highlight(Buffer buffer, Integer src_id, String hl_group, Integer line,
	...
	// void nvim_buf_clear_highlight(Buffer buffer, Integer src_id, Integer line_start, Integer
	// line_end, )
	...
	// )
	MsgpackRequest* nvim_replace_termcodes(QByteArray str, bool from_part, bool do_lt,
										   bool special);
	...
	// void nvim_set_client_info(String name, Dictionary version, String type, Dictionary methods,
	// Dictionary attributes, )
	MsgpackRequest* nvim_set_client_info(QByteArray name, QVariantMap version, QByteArray type,
	...
	// DEPRECATED
	// ArrayOf(String) buffer_get_lines(Buffer buffer, Integer start, Integer end, Boolean
	// strict_indexing, )
	MsgpackRequest* buffer_get_lines(int64_t buffer, int64_t start, int64_t end,
									 bool strict_indexing);
	// DEPRECATED
	// void buffer_set_lines(Buffer buffer, Integer start, Integer end, Boolean strict_indexing,
	// ArrayOf(String) replacement, )
	MsgpackRequest* buffer_set_lines(int64_t buffer, int64_t start, int64_t end,
									 bool strict_indexing, QList<QByteArray> replacement);
	// DEPRECATED
	...
	// DEPRECATED
	// Integer buffer_add_highlight(Buffer buffer, Integer src_id, String hl_group, Integer line,
	// Integer col_start, Integer col_end, )
	MsgpackRequest* buffer_add_highlight(int64_t buffer, int64_t src_id, QByteArray hl_group,
										 int64_t line, int64_t col_start, int64_t col_end);
	// DEPRECATED
	// void buffer_clear_highlight(Buffer buffer, Integer src_id, Integer line_start, Integer
	// line_end, )
