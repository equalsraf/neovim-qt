// Auto generated 2021-07-31 13:12:21.940599 from nvim API level:2
#pragma once
...
public slots:
	...
	NeovimQt::MsgpackRequest* nvim_buf_add_highlight(int64_t buffer, int64_t src_id, QByteArray hl_group, int64_t line, int64_t col_start, int64_t col_end) noexcept;
			// void nvim_buf_clear_highlight(Buffer buffer, Integer src_id, Integer line_start, Integer line_end, )
	NeovimQt::MsgpackRequest* nvim_buf_clear_highlight(int64_t buffer, int64_t src_id, int64_t line_start, int64_t line_end) noexcept;
	...
	NeovimQt::MsgpackRequest* nvim_command_output(QByteArray str) noexcept;
	...
	NeovimQt::MsgpackRequest* nvim_call_function(QByteArray fname, QVariantList args) noexcept;
			// Integer nvim_strwidth(String str, )
	NeovimQt::MsgpackRequest* nvim_strwidth(QByteArray str) noexcept;
	...
	NeovimQt::MsgpackRequest* buffer_add_highlight(int64_t buffer, int64_t src_id, QByteArray hl_group, int64_t line, int64_t col_start, int64_t col_end) noexcept;
			// DEPRECATED
		// void buffer_clear_highlight(Buffer buffer, Integer src_id, Integer line_start, Integer line_end, )
	NeovimQt::MsgpackRequest* buffer_clear_highlight(int64_t buffer, int64_t src_id, int64_t line_start, int64_t line_end) noexcept;
			// DEPRECATED
	...
	NeovimQt::MsgpackRequest* vim_command_output(QByteArray str) noexcept;
			// DEPRECATED
	...
	NeovimQt::MsgpackRequest* vim_call_function(QByteArray fname, QVariantList args) noexcept;
			// DEPRECATED
		// Integer vim_strwidth(String str, )
	NeovimQt::MsgpackRequest* vim_strwidth(QByteArray str) noexcept;
			// DEPRECATED
