...
NeovimApi2::NeovimApi2(NeovimConnector* c): m_c(c)
{
	...
	connect(m_c->m_dev, &MsgpackIODevice::notification, this, &NeovimApi2::neovimNotification);
}
...
MsgpackRequest* NeovimApi2::buffer_get_line_slice(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest* NeovimApi2::nvim_buf_get_lines(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest* NeovimApi2::buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end,
												  bool include_start, bool include_end,
...
MsgpackRequest* NeovimApi2::nvim_buf_set_lines(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest* NeovimApi2::nvim_buf_add_highlight(int64_t buffer, int64_t src_id,
...
MsgpackRequest* NeovimApi2::nvim_buf_clear_highlight(int64_t buffer, int64_t src_id,
...
MsgpackRequest* NeovimApi2::nvim_replace_termcodes(QByteArray str, bool from_part, bool do_lt,
												   bool special)
{
...
MsgpackRequest* NeovimApi2::buffer_get_lines(int64_t buffer, int64_t start, int64_t end,
											 bool strict_indexing)
{
...
MsgpackRequest* NeovimApi2::buffer_set_lines(int64_t buffer, int64_t start, int64_t end,
											 bool strict_indexing, QList<QByteArray> replacement)
{
...
MsgpackRequest* NeovimApi2::buffer_clear_highlight(int64_t buffer, int64_t src_id,
												   int64_t line_start, int64_t line_end)
{
...
MsgpackRequest* NeovimApi2::vim_replace_termcodes(QByteArray str, bool from_part, bool do_lt,
												  bool special)
{
