// Auto generated 2021-07-31 13:15:11.042919 from nvim API level:6
...
static QVariant unpackBufferApi6(MsgpackIODevice *dev, const char* in, quint32 size) noexcept
{
...
static QVariant unpackWindowApi6(MsgpackIODevice *dev, const char* in, quint32 size) noexcept
{
	return unpackBufferApi6(dev, in, size);
}

static QVariant unpackTabpageApi6(MsgpackIODevice* dev, const char* in, quint32 size) noexcept
{
	return unpackBufferApi6(dev, in, size);
}
...
// Slots
MsgpackRequest* NeovimApi6::nvim_buf_line_count(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_get_line(int64_t buffer, int64_t index) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_attach(int64_t buffer, bool send_buffer, QVariantMap opts) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_detach(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_set_line(int64_t buffer, int64_t index, QByteArray line) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_del_line(int64_t buffer, int64_t index) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_get_line_slice(int64_t buffer, int64_t start, int64_t end, bool include_start, bool include_end) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_lines(int64_t buffer, int64_t start, int64_t end, bool strict_indexing) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end, bool include_start, bool include_end, QList<QByteArray> replacement) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_set_lines(int64_t buffer, int64_t start, int64_t end, bool strict_indexing, QList<QByteArray> replacement) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_offset(int64_t buffer, int64_t index) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_var(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_changedtick(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_keymap(int64_t buffer, QByteArray mode) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_set_keymap(int64_t buffer, QByteArray mode, QByteArray lhs, QByteArray rhs, QVariantMap opts) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_del_keymap(int64_t buffer, QByteArray mode, QByteArray lhs) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_commands(int64_t buffer, QVariantMap opts) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_set_var(int64_t buffer, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_del_var(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_set_var(int64_t buffer, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_del_var(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_option(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_set_option(int64_t buffer, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_number(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_name(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_set_name(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_is_loaded(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_is_valid(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_insert(int64_t buffer, int64_t lnum, QList<QByteArray> lines) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_get_mark(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_add_highlight(int64_t buffer, int64_t ns_id, QByteArray hl_group, int64_t line, int64_t col_start, int64_t col_end) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_clear_namespace(int64_t buffer, int64_t ns_id, int64_t line_start, int64_t line_end) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_clear_highlight(int64_t buffer, int64_t ns_id, int64_t line_start, int64_t line_end) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_buf_set_virtual_text(int64_t buffer, int64_t ns_id, int64_t line, QVariantList chunks, QVariantMap opts) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_tabpage_list_wins(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_tabpage_get_var(int64_t tabpage, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_tabpage_set_var(int64_t tabpage, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_tabpage_del_var(int64_t tabpage, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::tabpage_set_var(int64_t tabpage, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::tabpage_del_var(int64_t tabpage, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_tabpage_get_win(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_tabpage_get_number(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_tabpage_is_valid(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_ui_attach(int64_t width, int64_t height, QVariantMap options) noexcept
{
...
MsgpackRequest* NeovimApi6::ui_attach(int64_t width, int64_t height, bool enable_rgb) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_ui_detach() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_ui_try_resize(int64_t width, int64_t height) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_ui_set_option(QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_ui_try_resize_grid(int64_t grid, int64_t width, int64_t height) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_ui_pum_set_height(int64_t height) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_command(QByteArray command) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_hl_by_name(QByteArray name, bool rgb) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_hl_by_id(int64_t hl_id, bool rgb) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_feedkeys(QByteArray keys, QByteArray mode, bool escape_csi) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_input(QByteArray keys) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_input_mouse(QByteArray button, QByteArray action, QByteArray modifier, int64_t grid, int64_t row, int64_t col) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_replace_termcodes(QByteArray str, bool from_part, bool do_lt, bool special) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_command_output(QByteArray command) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_eval(QByteArray expr) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_execute_lua(QByteArray code, QVariantList args) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_call_function(QByteArray fn, QVariantList args) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_call_dict_function(QVariant dict, QByteArray fn, QVariantList args) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_strwidth(QByteArray text) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_list_runtime_paths() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_current_dir(QByteArray dir) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_current_line() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_current_line(QByteArray line) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_del_current_line() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_var(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_var(QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_del_var(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_set_var(QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_del_var(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_vvar(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_vvar(QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_option(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_option(QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_out_write(QByteArray str) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_err_write(QByteArray str) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_err_writeln(QByteArray str) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_list_bufs() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_current_buf() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_current_buf(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_list_wins() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_current_win() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_current_win(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_create_buf(bool listed, bool scratch) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_open_win(int64_t buffer, bool enter, QVariantMap config) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_list_tabpages() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_current_tabpage() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_current_tabpage(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_create_namespace(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_namespaces() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_paste(QByteArray data, bool crlf, int64_t phase) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_put(QList<QByteArray> lines, QByteArray type, bool after, bool follow) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_subscribe(QByteArray event) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_unsubscribe(QByteArray event) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_color_by_name(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_color_map() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_context(QVariantMap opts) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_load_context(QVariantMap dict) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_mode() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_keymap(QByteArray mode) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_keymap(QByteArray mode, QByteArray lhs, QByteArray rhs, QVariantMap opts) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_del_keymap(QByteArray mode, QByteArray lhs) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_commands(QVariantMap opts) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_api_info() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_set_client_info(QByteArray name, QVariantMap version, QByteArray type, QVariantMap methods, QVariantMap attributes) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_chan_info(int64_t chan) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_list_chans() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_call_atomic(QVariantList calls) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_parse_expression(QByteArray expr, QByteArray flags, bool highlight) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_list_uis() noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_proc_children(int64_t pid) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_get_proc(int64_t pid) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_select_popupmenu_item(int64_t item, bool insert, bool finish, QVariantMap opts) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_buf(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_set_buf(int64_t window, int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_cursor(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_set_cursor(int64_t window, QPoint pos) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_height(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_set_height(int64_t window, int64_t height) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_width(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_set_width(int64_t window, int64_t width) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_var(int64_t window, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_set_var(int64_t window, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_del_var(int64_t window, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::window_set_var(int64_t window, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::window_del_var(int64_t window, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_option(int64_t window, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_set_option(int64_t window, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_position(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_tabpage(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_number(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_is_valid(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_set_config(int64_t window, QVariantMap config) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_get_config(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::nvim_win_close(int64_t window, bool force) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_line_count(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_get_lines(int64_t buffer, int64_t start, int64_t end, bool strict_indexing) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_set_lines(int64_t buffer, int64_t start, int64_t end, bool strict_indexing, QList<QByteArray> replacement) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_get_var(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_get_option(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_set_option(int64_t buffer, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_get_number(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_get_name(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_set_name(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_is_valid(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_get_mark(int64_t buffer, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_add_highlight(int64_t buffer, int64_t ns_id, QByteArray hl_group, int64_t line, int64_t col_start, int64_t col_end) noexcept
{
...
MsgpackRequest* NeovimApi6::buffer_clear_highlight(int64_t buffer, int64_t ns_id, int64_t line_start, int64_t line_end) noexcept
{
...
MsgpackRequest* NeovimApi6::tabpage_get_windows(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::tabpage_get_var(int64_t tabpage, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::tabpage_get_window(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::tabpage_is_valid(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::ui_detach() noexcept
{
...
MsgpackRequest* NeovimApi6::ui_try_resize(int64_t width, int64_t height) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_command(QByteArray command) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_feedkeys(QByteArray keys, QByteArray mode, bool escape_csi) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_input(QByteArray keys) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_replace_termcodes(QByteArray str, bool from_part, bool do_lt, bool special) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_command_output(QByteArray command) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_eval(QByteArray expr) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_call_function(QByteArray fn, QVariantList args) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_strwidth(QByteArray text) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_list_runtime_paths() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_change_directory(QByteArray dir) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_current_line() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_set_current_line(QByteArray line) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_del_current_line() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_var(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_vvar(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_option(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_set_option(QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_out_write(QByteArray str) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_err_write(QByteArray str) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_report_error(QByteArray str) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_buffers() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_current_buffer() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_set_current_buffer(int64_t buffer) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_windows() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_current_window() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_set_current_window(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_tabpages() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_current_tabpage() noexcept
{
...
MsgpackRequest* NeovimApi6::vim_set_current_tabpage(int64_t tabpage) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_subscribe(QByteArray event) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_unsubscribe(QByteArray event) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_name_to_color(QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::vim_get_color_map() noexcept
{
...
MsgpackRequest* NeovimApi6::window_get_buffer(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::window_get_cursor(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::window_set_cursor(int64_t window, QPoint pos) noexcept
{
...
MsgpackRequest* NeovimApi6::window_get_height(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::window_set_height(int64_t window, int64_t height) noexcept
{
...
MsgpackRequest* NeovimApi6::window_get_width(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::window_set_width(int64_t window, int64_t width) noexcept
{
...
MsgpackRequest* NeovimApi6::window_get_var(int64_t window, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::window_get_option(int64_t window, QByteArray name) noexcept
{
...
MsgpackRequest* NeovimApi6::window_set_option(int64_t window, QByteArray name, QVariant value) noexcept
{
...
MsgpackRequest* NeovimApi6::window_get_position(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::window_get_tabpage(int64_t window) noexcept
{
...
MsgpackRequest* NeovimApi6::window_is_valid(int64_t window) noexcept
{
...
// Handlers
void NeovimApi6::handleResponseError(quint32 msgid, quint64 fun, const QVariant& res) noexcept
{
...
void NeovimApi6::handleResponse(quint32 msgid, quint64 fun, const QVariant& res) noexcept
{
	switch(fun)
	{
		case NeovimApi6::NEOVIM_FN_NVIM_BUF_LINE_COUNT:
...
bool NeovimApi6::checkFunctions(const QVariantList& ftable) noexcept
{
