// Auto generated 2026-08-29 16:04:49.700139 from nvim API level:7
 ...
 */
QVariant unpackBufferApi7(MsgpackIODevice *dev, const char* in, quint32 size)
{
...
#define unpackWindowApi7 unpackBufferApi7
#define unpackTabpageApi7 unpackBufferApi7

NeovimApi7::NeovimApi7(NeovimConnector *c)
:m_c(c)
{
	// EXT types
		m_c->m_dev->registerExtType(0, unpackBufferApi7);
		m_c->m_dev->registerExtType(1, unpackWindowApi7);
		m_c->m_dev->registerExtType(2, unpackTabpageApi7);
		connect(m_c->m_dev, &MsgpackIODevice::notification,
			this, &NeovimApi7::neovimNotification);
}

// Slots
MsgpackRequest* NeovimApi7::nvim_buf_line_count(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_line_count", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_LINE_COUNT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_buf_attach(int64_t buffer, bool send_buffer, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_attach", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_ATTACH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
...
MsgpackRequest* NeovimApi7::nvim_buf_detach(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_detach", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_DETACH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_buf_get_lines(int64_t buffer, int64_t start, int64_t end, bool strict_indexing)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_lines", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_LINES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
...
MsgpackRequest* NeovimApi7::nvim_buf_set_lines(int64_t buffer, int64_t start, int64_t end, bool strict_indexing, QList<QByteArray> replacement)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_set_lines", 5);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_LINES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(start);
...
MsgpackRequest* NeovimApi7::nvim_buf_set_text(int64_t buffer, int64_t start_row, int64_t start_col, int64_t end_row, int64_t end_col, QList<QByteArray> replacement)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_set_text", 6);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_TEXT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(start_row);
	m_c->m_dev->send(start_col);
	m_c->m_dev->send(end_row);
	m_c->m_dev->send(end_col);
	m_c->m_dev->sendArrayOf(replacement);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_buf_get_offset(int64_t buffer, int64_t index)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_offset", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_OFFSET);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
...
MsgpackRequest* NeovimApi7::nvim_buf_get_var(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_buf_get_changedtick(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_changedtick", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_CHANGEDTICK);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_buf_get_keymap(int64_t buffer, QByteArray mode)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_keymap", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_KEYMAP);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(mode);
...
MsgpackRequest* NeovimApi7::nvim_buf_set_keymap(int64_t buffer, QByteArray mode, QByteArray lhs, QByteArray rhs, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_set_keymap", 5);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_KEYMAP);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(mode);
...
MsgpackRequest* NeovimApi7::nvim_buf_del_keymap(int64_t buffer, QByteArray mode, QByteArray lhs)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_del_keymap", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_DEL_KEYMAP);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(mode);
...
MsgpackRequest* NeovimApi7::nvim_buf_get_commands(int64_t buffer, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_commands", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_COMMANDS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(opts);
...
MsgpackRequest* NeovimApi7::nvim_buf_set_var(int64_t buffer, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_set_var", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_buf_del_var(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_del_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_DEL_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_buf_get_option(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_option", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_buf_set_option(int64_t buffer, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_set_option", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_buf_get_name(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_name", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_NAME);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_buf_set_name(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_set_name", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_NAME);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_buf_is_loaded(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_is_loaded", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_IS_LOADED);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_buf_delete(int64_t buffer, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_delete", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_DELETE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(opts);
...
MsgpackRequest* NeovimApi7::nvim_buf_is_valid(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_is_valid", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_IS_VALID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_buf_get_mark(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_mark", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_MARK);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_buf_get_extmark_by_id(int64_t buffer, int64_t ns_id, int64_t id, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_extmark_by_id", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_EXTMARK_BY_ID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
...
MsgpackRequest* NeovimApi7::nvim_buf_get_extmarks(int64_t buffer, int64_t ns_id, QVariant start, QVariant end, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_extmarks", 5);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_EXTMARKS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(ns_id);
...
MsgpackRequest* NeovimApi7::nvim_buf_set_extmark(int64_t buffer, int64_t ns_id, int64_t line, int64_t col, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_set_extmark", 5);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_EXTMARK);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(ns_id);
...
MsgpackRequest* NeovimApi7::nvim_buf_del_extmark(int64_t buffer, int64_t ns_id, int64_t id)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_del_extmark", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_DEL_EXTMARK);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(ns_id);
...
MsgpackRequest* NeovimApi7::nvim_buf_add_highlight(int64_t buffer, int64_t ns_id, QByteArray hl_group, int64_t line, int64_t col_start, int64_t col_end)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_add_highlight", 6);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_ADD_HIGHLIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(ns_id);
...
MsgpackRequest* NeovimApi7::nvim_buf_clear_namespace(int64_t buffer, int64_t ns_id, int64_t line_start, int64_t line_end)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_clear_namespace", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_CLEAR_NAMESPACE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(ns_id);
...
MsgpackRequest* NeovimApi7::nvim_buf_set_virtual_text(int64_t buffer, int64_t src_id, int64_t line, QVariantList chunks, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_set_virtual_text", 5);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_VIRTUAL_TEXT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
...
MsgpackRequest* NeovimApi7::nvim_buf_call(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_call", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_CALL);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_command_output(QByteArray command)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_command_output", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_COMMAND_OUTPUT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(command);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_execute_lua(QByteArray code, QVariantList args)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_execute_lua", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_EXECUTE_LUA);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(code);
	m_c->m_dev->send(args);
...
MsgpackRequest* NeovimApi7::nvim_buf_get_number(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_get_number", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_NUMBER);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_buf_clear_highlight(int64_t buffer, int64_t ns_id, int64_t line_start, int64_t line_end)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_buf_clear_highlight", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_BUF_CLEAR_HIGHLIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(ns_id);
...
MsgpackRequest* NeovimApi7::buffer_insert(int64_t buffer, int64_t lnum, QList<QByteArray> lines)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_insert", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_INSERT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(lnum);
...
MsgpackRequest* NeovimApi7::buffer_get_line(int64_t buffer, int64_t index)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_get_line", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_GET_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(index);
...
MsgpackRequest* NeovimApi7::buffer_set_line(int64_t buffer, int64_t index, QByteArray line)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_set_line", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_SET_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(index);
...
MsgpackRequest* NeovimApi7::buffer_del_line(int64_t buffer, int64_t index)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_del_line", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_DEL_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(index);
...
MsgpackRequest* NeovimApi7::buffer_get_line_slice(int64_t buffer, int64_t start, int64_t end, bool include_start, bool include_end)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_get_line_slice", 5);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_GET_LINE_SLICE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(start);
...
MsgpackRequest* NeovimApi7::buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end, bool include_start, bool include_end, QList<QByteArray> replacement)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_set_line_slice", 6);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_SET_LINE_SLICE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(start);
...
MsgpackRequest* NeovimApi7::buffer_set_var(int64_t buffer, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_set_var", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_SET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::buffer_del_var(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_del_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_DEL_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::window_set_var(int64_t window, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_set_var", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_SET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
...
MsgpackRequest* NeovimApi7::window_del_var(int64_t window, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_del_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_DEL_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::tabpage_set_var(int64_t tabpage, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("tabpage_set_var", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_TABPAGE_SET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
...
MsgpackRequest* NeovimApi7::tabpage_del_var(int64_t tabpage, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("tabpage_del_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_TABPAGE_DEL_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::vim_set_var(QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_set_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_SET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	m_c->m_dev->send(value);
...
MsgpackRequest* NeovimApi7::vim_del_var(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_del_var", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_DEL_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_tabpage_list_wins(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_tabpage_list_wins", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_LIST_WINS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_tabpage_get_var(int64_t tabpage, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_tabpage_get_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_GET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_tabpage_set_var(int64_t tabpage, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_tabpage_set_var", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_SET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_tabpage_del_var(int64_t tabpage, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_tabpage_del_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_DEL_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_tabpage_get_win(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_tabpage_get_win", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_GET_WIN);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_tabpage_get_number(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_tabpage_get_number", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_GET_NUMBER);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_tabpage_is_valid(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_tabpage_is_valid", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_IS_VALID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_ui_attach(int64_t width, int64_t height, QVariantMap options)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_ui_attach", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_UI_ATTACH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
...
MsgpackRequest* NeovimApi7::ui_attach(int64_t width, int64_t height, bool enable_rgb)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("ui_attach", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_UI_ATTACH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(width);
	m_c->m_dev->send(height);
...
MsgpackRequest* NeovimApi7::nvim_ui_detach()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_ui_detach", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_UI_DETACH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_ui_try_resize(int64_t width, int64_t height)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_ui_try_resize", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_UI_TRY_RESIZE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(width);
	m_c->m_dev->send(height);
...
MsgpackRequest* NeovimApi7::nvim_ui_set_option(QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_ui_set_option", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_UI_SET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	m_c->m_dev->send(value);
...
MsgpackRequest* NeovimApi7::nvim_ui_try_resize_grid(int64_t grid, int64_t width, int64_t height)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_ui_try_resize_grid", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_UI_TRY_RESIZE_GRID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(grid);
	m_c->m_dev->send(width);
...
MsgpackRequest* NeovimApi7::nvim_ui_pum_set_height(int64_t height)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_ui_pum_set_height", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_UI_PUM_SET_HEIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(height);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_ui_pum_set_bounds(double width, double height, double row, double col)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_ui_pum_set_bounds", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_UI_PUM_SET_BOUNDS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(width);
	m_c->m_dev->send(height);
...
MsgpackRequest* NeovimApi7::nvim_exec(QByteArray src, bool output)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_exec", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_EXEC);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(src);
	m_c->m_dev->send(output);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_command(QByteArray command)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_command", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_COMMAND);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(command);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_hl_by_name(QByteArray name, bool rgb)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_hl_by_name", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_HL_BY_NAME);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	m_c->m_dev->send(rgb);
...
MsgpackRequest* NeovimApi7::nvim_get_hl_by_id(int64_t hl_id, bool rgb)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_hl_by_id", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_HL_BY_ID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
...
MsgpackRequest* NeovimApi7::nvim_get_hl_id_by_name(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_hl_id_by_name", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_HL_ID_BY_NAME);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_hl(int64_t ns_id, QByteArray name, QVariantMap val)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_hl", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_HL);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(ns_id);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_feedkeys(QByteArray keys, QByteArray mode, bool escape_csi)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_feedkeys", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_FEEDKEYS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(keys);
	m_c->m_dev->send(mode);
...
MsgpackRequest* NeovimApi7::nvim_input(QByteArray keys)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_input", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_INPUT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(keys);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_input_mouse(QByteArray button, QByteArray action, QByteArray modifier, int64_t grid, int64_t row, int64_t col)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_input_mouse", 6);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_INPUT_MOUSE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
...
MsgpackRequest* NeovimApi7::nvim_replace_termcodes(QByteArray str, bool from_part, bool do_lt, bool special)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_replace_termcodes", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_REPLACE_TERMCODES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(str);
...
MsgpackRequest* NeovimApi7::nvim_eval(QByteArray expr)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_eval", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_EVAL);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(expr);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_exec_lua(QByteArray code, QVariantList args)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_exec_lua", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_EXEC_LUA);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(code);
	m_c->m_dev->send(args);
...
MsgpackRequest* NeovimApi7::nvim_notify(QByteArray msg, int64_t log_level, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_notify", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_NOTIFY);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(msg);
	m_c->m_dev->send(log_level);
	m_c->m_dev->send(opts);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_call_function(QByteArray fn, QVariantList args)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_call_function", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_CALL_FUNCTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(fn);
	m_c->m_dev->send(args);
...
MsgpackRequest* NeovimApi7::nvim_call_dict_function(QVariant dict, QByteArray fn, QVariantList args)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_call_dict_function", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_CALL_DICT_FUNCTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(dict);
	m_c->m_dev->send(fn);
...
MsgpackRequest* NeovimApi7::nvim_strwidth(QByteArray text)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_strwidth", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_STRWIDTH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(text);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_list_runtime_paths()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_list_runtime_paths", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_LIST_RUNTIME_PATHS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_runtime_file(QByteArray name, bool all)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_runtime_file", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_RUNTIME_FILE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	m_c->m_dev->send(all);
...
MsgpackRequest* NeovimApi7::nvim_set_current_dir(QByteArray dir)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_current_dir", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_DIR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(dir);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_current_line()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_current_line", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_CURRENT_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_current_line(QByteArray line)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_current_line", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(line);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_del_current_line()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_del_current_line", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_DEL_CURRENT_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_var(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_var", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_var(QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	m_c->m_dev->send(value);
...
MsgpackRequest* NeovimApi7::nvim_del_var(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_del_var", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_DEL_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_vvar(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_vvar", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_VVAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_vvar(QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_vvar", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_VVAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	m_c->m_dev->send(value);
...
MsgpackRequest* NeovimApi7::nvim_get_option(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_option", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_all_options_info()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_all_options_info", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_ALL_OPTIONS_INFO);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_option_info(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_option_info", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_OPTION_INFO);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_option(QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_option", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	m_c->m_dev->send(value);
...
MsgpackRequest* NeovimApi7::nvim_echo(QVariantList chunks, bool history, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_echo", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_ECHO);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(chunks);
	m_c->m_dev->send(history);
	m_c->m_dev->send(opts);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_out_write(QByteArray str)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_out_write", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_OUT_WRITE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(str);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_err_write(QByteArray str)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_err_write", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_ERR_WRITE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(str);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_err_writeln(QByteArray str)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_err_writeln", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_ERR_WRITELN);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(str);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_list_bufs()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_list_bufs", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_LIST_BUFS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_current_buf()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_current_buf", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_CURRENT_BUF);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_current_buf(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_current_buf", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_BUF);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_list_wins()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_list_wins", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_LIST_WINS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_current_win()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_current_win", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_CURRENT_WIN);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_current_win(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_current_win", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_WIN);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_create_buf(bool listed, bool scratch)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_create_buf", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_CREATE_BUF);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
...
MsgpackRequest* NeovimApi7::nvim_open_term(int64_t buffer, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_open_term", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_OPEN_TERM);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(opts);
...
MsgpackRequest* NeovimApi7::nvim_chan_send(int64_t chan, QByteArray data)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_chan_send", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_CHAN_SEND);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(chan);
	m_c->m_dev->send(data);
...
MsgpackRequest* NeovimApi7::nvim_open_win(int64_t buffer, bool enter, QVariantMap config)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_open_win", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_OPEN_WIN);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
...
MsgpackRequest* NeovimApi7::nvim_list_tabpages()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_list_tabpages", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_LIST_TABPAGES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_current_tabpage()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_current_tabpage", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_CURRENT_TABPAGE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_current_tabpage(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_current_tabpage", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_TABPAGE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_create_namespace(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_create_namespace", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_CREATE_NAMESPACE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_namespaces()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_namespaces", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_NAMESPACES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_paste(QByteArray data, bool crlf, int64_t phase)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_paste", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_PASTE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(data);
	m_c->m_dev->send(crlf);
...
MsgpackRequest* NeovimApi7::nvim_put(QList<QByteArray> lines, QByteArray type, bool after, bool follow)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_put", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_PUT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->sendArrayOf(lines);
	m_c->m_dev->send(type);
...
MsgpackRequest* NeovimApi7::nvim_subscribe(QByteArray event)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_subscribe", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SUBSCRIBE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(event);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_unsubscribe(QByteArray event)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_unsubscribe", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_UNSUBSCRIBE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(event);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_color_by_name(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_color_by_name", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_COLOR_BY_NAME);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_color_map()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_color_map", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_COLOR_MAP);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_context(QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_context", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_CONTEXT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(opts);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_load_context(QVariantMap dict)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_load_context", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_LOAD_CONTEXT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(dict);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_mode()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_mode", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_MODE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_keymap(QByteArray mode)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_keymap", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_KEYMAP);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(mode);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_keymap(QByteArray mode, QByteArray lhs, QByteArray rhs, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_keymap", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_KEYMAP);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(mode);
	m_c->m_dev->send(lhs);
...
MsgpackRequest* NeovimApi7::nvim_del_keymap(QByteArray mode, QByteArray lhs)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_del_keymap", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_DEL_KEYMAP);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(mode);
	m_c->m_dev->send(lhs);
...
MsgpackRequest* NeovimApi7::nvim_get_commands(QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_commands", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_COMMANDS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(opts);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_api_info()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_api_info", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_API_INFO);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_set_client_info(QByteArray name, QVariantMap version, QByteArray type, QVariantMap methods, QVariantMap attributes)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_client_info", 5);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_CLIENT_INFO);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_get_chan_info(int64_t chan)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_chan_info", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_CHAN_INFO);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(chan);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_list_chans()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_list_chans", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_LIST_CHANS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_call_atomic(QVariantList calls)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_call_atomic", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_CALL_ATOMIC);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(calls);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_parse_expression(QByteArray expr, QByteArray flags, bool highlight)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_parse_expression", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_PARSE_EXPRESSION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(expr);
...
MsgpackRequest* NeovimApi7::nvim_list_uis()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_list_uis", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_LIST_UIS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_proc_children(int64_t pid)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_proc_children", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_PROC_CHILDREN);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(pid);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_get_proc(int64_t pid)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_get_proc", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_GET_PROC);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(pid);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_select_popupmenu_item(int64_t item, bool insert, bool finish, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_select_popupmenu_item", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SELECT_POPUPMENU_ITEM);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(item);
...
MsgpackRequest* NeovimApi7::nvim_set_decoration_provider(int64_t ns_id, QVariantMap opts)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_set_decoration_provider", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_SET_DECORATION_PROVIDER);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(ns_id);
	m_c->m_dev->send(opts);
...
MsgpackRequest* NeovimApi7::nvim_win_get_buf(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_buf", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_BUF);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_set_buf(int64_t window, int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_set_buf", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_BUF);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(buffer);
...
MsgpackRequest* NeovimApi7::nvim_win_get_cursor(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_cursor", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_CURSOR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_set_cursor(int64_t window, QPoint pos)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_set_cursor", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_CURSOR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(pos);
...
MsgpackRequest* NeovimApi7::nvim_win_get_height(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_height", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_HEIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_set_height(int64_t window, int64_t height)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_set_height", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_HEIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(height);
...
MsgpackRequest* NeovimApi7::nvim_win_get_width(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_width", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_WIDTH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_set_width(int64_t window, int64_t width)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_set_width", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_WIDTH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(width);
...
MsgpackRequest* NeovimApi7::nvim_win_get_var(int64_t window, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_win_set_var(int64_t window, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_set_var", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_win_del_var(int64_t window, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_del_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_DEL_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_win_get_option(int64_t window, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_option", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_win_set_option(int64_t window, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_set_option", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::nvim_win_get_position(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_position", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_POSITION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_get_tabpage(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_tabpage", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_TABPAGE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_get_number(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_number", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_NUMBER);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_is_valid(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_is_valid", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_IS_VALID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_set_config(int64_t window, QVariantMap config)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_set_config", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_CONFIG);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(config);
...
MsgpackRequest* NeovimApi7::nvim_win_get_config(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_get_config", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_CONFIG);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_hide(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_hide", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_HIDE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::nvim_win_close(int64_t window, bool force)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_close", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_CLOSE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
...
MsgpackRequest* NeovimApi7::nvim_win_call(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("nvim_win_call", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_NVIM_WIN_CALL);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::buffer_line_count(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_line_count", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_LINE_COUNT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::buffer_get_lines(int64_t buffer, int64_t start, int64_t end, bool strict_indexing)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_get_lines", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_GET_LINES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(start);
...
MsgpackRequest* NeovimApi7::buffer_set_lines(int64_t buffer, int64_t start, int64_t end, bool strict_indexing, QList<QByteArray> replacement)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_set_lines", 5);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_SET_LINES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(start);
...
MsgpackRequest* NeovimApi7::buffer_get_var(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_get_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_GET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::buffer_get_option(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_get_option", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_GET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::buffer_set_option(int64_t buffer, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_set_option", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_SET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::buffer_get_name(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_get_name", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_GET_NAME);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::buffer_set_name(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_set_name", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_SET_NAME);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::buffer_is_valid(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_is_valid", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_IS_VALID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::buffer_get_mark(int64_t buffer, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_get_mark", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_GET_MARK);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::buffer_add_highlight(int64_t buffer, int64_t ns_id, QByteArray hl_group, int64_t line, int64_t col_start, int64_t col_end)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_add_highlight", 6);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_ADD_HIGHLIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(ns_id);
...
MsgpackRequest* NeovimApi7::vim_command_output(QByteArray command)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_command_output", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_COMMAND_OUTPUT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(command);
	return r;
}
MsgpackRequest* NeovimApi7::buffer_get_number(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_get_number", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_GET_NUMBER);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::buffer_clear_highlight(int64_t buffer, int64_t ns_id, int64_t line_start, int64_t line_end)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("buffer_clear_highlight", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_BUFFER_CLEAR_HIGHLIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	m_c->m_dev->send(ns_id);
...
MsgpackRequest* NeovimApi7::tabpage_get_windows(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("tabpage_get_windows", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_TABPAGE_GET_WINDOWS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::tabpage_get_var(int64_t tabpage, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("tabpage_get_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_TABPAGE_GET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::tabpage_get_window(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("tabpage_get_window", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_TABPAGE_GET_WINDOW);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::tabpage_is_valid(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("tabpage_is_valid", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_TABPAGE_IS_VALID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::ui_detach()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("ui_detach", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_UI_DETACH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::ui_try_resize(int64_t width, int64_t height)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("ui_try_resize", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_UI_TRY_RESIZE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(width);
	m_c->m_dev->send(height);
...
MsgpackRequest* NeovimApi7::vim_command(QByteArray command)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_command", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_COMMAND);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(command);
	return r;
}
MsgpackRequest* NeovimApi7::vim_feedkeys(QByteArray keys, QByteArray mode, bool escape_csi)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_feedkeys", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_FEEDKEYS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(keys);
	m_c->m_dev->send(mode);
...
MsgpackRequest* NeovimApi7::vim_input(QByteArray keys)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_input", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_INPUT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(keys);
	return r;
}
MsgpackRequest* NeovimApi7::vim_replace_termcodes(QByteArray str, bool from_part, bool do_lt, bool special)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_replace_termcodes", 4);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_REPLACE_TERMCODES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(str);
	m_c->m_dev->send(from_part);
...
MsgpackRequest* NeovimApi7::vim_eval(QByteArray expr)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_eval", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_EVAL);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(expr);
	return r;
}
MsgpackRequest* NeovimApi7::vim_call_function(QByteArray fn, QVariantList args)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_call_function", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_CALL_FUNCTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(fn);
	m_c->m_dev->send(args);
...
MsgpackRequest* NeovimApi7::vim_strwidth(QByteArray text)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_strwidth", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_STRWIDTH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(text);
	return r;
}
MsgpackRequest* NeovimApi7::vim_list_runtime_paths()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_list_runtime_paths", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_LIST_RUNTIME_PATHS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_change_directory(QByteArray dir)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_change_directory", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_CHANGE_DIRECTORY);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(dir);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_current_line()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_current_line", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_CURRENT_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_set_current_line(QByteArray line)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_set_current_line", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_SET_CURRENT_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(line);
	return r;
}
MsgpackRequest* NeovimApi7::vim_del_current_line()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_del_current_line", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_DEL_CURRENT_LINE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_var(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_var", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_vvar(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_vvar", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_VVAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_option(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_option", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::vim_set_option(QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_set_option", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_SET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	m_c->m_dev->send(value);
...
MsgpackRequest* NeovimApi7::vim_out_write(QByteArray str)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_out_write", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_OUT_WRITE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(str);
	return r;
}
MsgpackRequest* NeovimApi7::vim_err_write(QByteArray str)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_err_write", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_ERR_WRITE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(str);
	return r;
}
MsgpackRequest* NeovimApi7::vim_report_error(QByteArray str)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_report_error", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_REPORT_ERROR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(str);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_buffers()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_buffers", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_BUFFERS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_current_buffer()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_current_buffer", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_CURRENT_BUFFER);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_set_current_buffer(int64_t buffer)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_set_current_buffer", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_SET_CURRENT_BUFFER);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(buffer);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_windows()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_windows", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_WINDOWS);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_current_window()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_current_window", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_CURRENT_WINDOW);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_set_current_window(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_set_current_window", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_SET_CURRENT_WINDOW);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_tabpages()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_tabpages", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_TABPAGES);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_current_tabpage()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_current_tabpage", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_CURRENT_TABPAGE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::vim_set_current_tabpage(int64_t tabpage)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_set_current_tabpage", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_SET_CURRENT_TABPAGE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(tabpage);
	return r;
}
MsgpackRequest* NeovimApi7::vim_subscribe(QByteArray event)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_subscribe", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_SUBSCRIBE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(event);
	return r;
}
MsgpackRequest* NeovimApi7::vim_unsubscribe(QByteArray event)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_unsubscribe", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_UNSUBSCRIBE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(event);
	return r;
}
MsgpackRequest* NeovimApi7::vim_name_to_color(QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_name_to_color", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_NAME_TO_COLOR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(name);
	return r;
}
MsgpackRequest* NeovimApi7::vim_get_color_map()
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("vim_get_color_map", 0);
	r->setFunction(NeovimApi7::NEOVIM_FN_VIM_GET_COLOR_MAP);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	return r;
}
MsgpackRequest* NeovimApi7::window_get_buffer(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_get_buffer", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_GET_BUFFER);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::window_get_cursor(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_get_cursor", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_GET_CURSOR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::window_set_cursor(int64_t window, QPoint pos)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_set_cursor", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_SET_CURSOR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(pos);
...
MsgpackRequest* NeovimApi7::window_get_height(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_get_height", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_GET_HEIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::window_set_height(int64_t window, int64_t height)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_set_height", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_SET_HEIGHT);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(height);
...
MsgpackRequest* NeovimApi7::window_get_width(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_get_width", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_GET_WIDTH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::window_set_width(int64_t window, int64_t width)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_set_width", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_SET_WIDTH);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(width);
...
MsgpackRequest* NeovimApi7::window_get_var(int64_t window, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_get_var", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_GET_VAR);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::window_get_option(int64_t window, QByteArray name)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_get_option", 2);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_GET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::window_set_option(int64_t window, QByteArray name, QVariant value)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_set_option", 3);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_SET_OPTION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	m_c->m_dev->send(name);
...
MsgpackRequest* NeovimApi7::window_get_position(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_get_position", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_GET_POSITION);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::window_get_tabpage(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_get_tabpage", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_GET_TABPAGE);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
}
MsgpackRequest* NeovimApi7::window_is_valid(int64_t window)
{
	MsgpackRequest *r = m_c->m_dev->startRequestUnchecked("window_is_valid", 1);
	r->setFunction(NeovimApi7::NEOVIM_FN_WINDOW_IS_VALID);
	connect(r, &MsgpackRequest::finished, this, &NeovimApi7::handleResponse);
	connect(r, &MsgpackRequest::error, this, &NeovimApi7::handleResponseError);
	m_c->m_dev->send(window);
	return r;
...
void NeovimApi7::handleResponseError(quint32 msgid, quint64 fun, const QVariant& res)
{
	...
	switch(fun) {
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_LINE_COUNT:
		emit err_nvim_buf_line_count(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_ATTACH:
		emit err_nvim_buf_attach(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_DETACH:
		emit err_nvim_buf_detach(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_LINES:
		emit err_nvim_buf_get_lines(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_LINES:
		emit err_nvim_buf_set_lines(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_TEXT:
		emit err_nvim_buf_set_text(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_OFFSET:
		emit err_nvim_buf_get_offset(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_VAR:
		emit err_nvim_buf_get_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_CHANGEDTICK:
		emit err_nvim_buf_get_changedtick(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_KEYMAP:
		emit err_nvim_buf_get_keymap(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_KEYMAP:
		emit err_nvim_buf_set_keymap(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_DEL_KEYMAP:
		emit err_nvim_buf_del_keymap(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_COMMANDS:
		emit err_nvim_buf_get_commands(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_VAR:
		emit err_nvim_buf_set_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_DEL_VAR:
		emit err_nvim_buf_del_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_OPTION:
		emit err_nvim_buf_get_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_OPTION:
		emit err_nvim_buf_set_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_NAME:
		emit err_nvim_buf_get_name(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_NAME:
		emit err_nvim_buf_set_name(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_IS_LOADED:
		emit err_nvim_buf_is_loaded(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_DELETE:
		emit err_nvim_buf_delete(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_IS_VALID:
		emit err_nvim_buf_is_valid(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_MARK:
		emit err_nvim_buf_get_mark(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_EXTMARK_BY_ID:
		emit err_nvim_buf_get_extmark_by_id(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_EXTMARKS:
		emit err_nvim_buf_get_extmarks(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_EXTMARK:
		emit err_nvim_buf_set_extmark(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_DEL_EXTMARK:
		emit err_nvim_buf_del_extmark(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_ADD_HIGHLIGHT:
		emit err_nvim_buf_add_highlight(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_CLEAR_NAMESPACE:
		emit err_nvim_buf_clear_namespace(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_VIRTUAL_TEXT:
		emit err_nvim_buf_set_virtual_text(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_CALL:
		emit err_nvim_buf_call(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_COMMAND_OUTPUT:
		emit err_nvim_command_output(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_EXECUTE_LUA:
		emit err_nvim_execute_lua(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_NUMBER:
		emit err_nvim_buf_get_number(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_CLEAR_HIGHLIGHT:
		emit err_nvim_buf_clear_highlight(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_INSERT:
		emit err_buffer_insert(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_GET_LINE:
		emit err_buffer_get_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_SET_LINE:
		emit err_buffer_set_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_DEL_LINE:
		emit err_buffer_del_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_GET_LINE_SLICE:
		emit err_buffer_get_line_slice(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_SET_LINE_SLICE:
		emit err_buffer_set_line_slice(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_SET_VAR:
		emit err_buffer_set_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_DEL_VAR:
		emit err_buffer_del_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_SET_VAR:
		emit err_window_set_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_DEL_VAR:
		emit err_window_del_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_TABPAGE_SET_VAR:
		emit err_tabpage_set_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_TABPAGE_DEL_VAR:
		emit err_tabpage_del_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_SET_VAR:
		emit err_vim_set_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_DEL_VAR:
		emit err_vim_del_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_LIST_WINS:
		emit err_nvim_tabpage_list_wins(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_GET_VAR:
		emit err_nvim_tabpage_get_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_SET_VAR:
		emit err_nvim_tabpage_set_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_DEL_VAR:
		emit err_nvim_tabpage_del_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_GET_WIN:
		emit err_nvim_tabpage_get_win(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_GET_NUMBER:
		emit err_nvim_tabpage_get_number(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_TABPAGE_IS_VALID:
		emit err_nvim_tabpage_is_valid(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_UI_ATTACH:
		emit err_nvim_ui_attach(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_UI_ATTACH:
		emit err_ui_attach(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_UI_DETACH:
		emit err_nvim_ui_detach(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_UI_TRY_RESIZE:
		emit err_nvim_ui_try_resize(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_UI_SET_OPTION:
		emit err_nvim_ui_set_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_UI_TRY_RESIZE_GRID:
		emit err_nvim_ui_try_resize_grid(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_UI_PUM_SET_HEIGHT:
		emit err_nvim_ui_pum_set_height(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_UI_PUM_SET_BOUNDS:
		emit err_nvim_ui_pum_set_bounds(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_EXEC:
		emit err_nvim_exec(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_COMMAND:
		emit err_nvim_command(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_HL_BY_NAME:
		emit err_nvim_get_hl_by_name(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_HL_BY_ID:
		emit err_nvim_get_hl_by_id(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_HL_ID_BY_NAME:
		emit err_nvim_get_hl_id_by_name(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_HL:
		emit err_nvim_set_hl(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_FEEDKEYS:
		emit err_nvim_feedkeys(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_INPUT:
		emit err_nvim_input(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_INPUT_MOUSE:
		emit err_nvim_input_mouse(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_REPLACE_TERMCODES:
		emit err_nvim_replace_termcodes(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_EVAL:
		emit err_nvim_eval(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_EXEC_LUA:
		emit err_nvim_exec_lua(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_NOTIFY:
		emit err_nvim_notify(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_CALL_FUNCTION:
		emit err_nvim_call_function(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_CALL_DICT_FUNCTION:
		emit err_nvim_call_dict_function(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_STRWIDTH:
		emit err_nvim_strwidth(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_LIST_RUNTIME_PATHS:
		emit err_nvim_list_runtime_paths(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_RUNTIME_FILE:
		emit err_nvim_get_runtime_file(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_DIR:
		emit err_nvim_set_current_dir(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_CURRENT_LINE:
		emit err_nvim_get_current_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_LINE:
		emit err_nvim_set_current_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_DEL_CURRENT_LINE:
		emit err_nvim_del_current_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_VAR:
		emit err_nvim_get_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_VAR:
		emit err_nvim_set_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_DEL_VAR:
		emit err_nvim_del_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_VVAR:
		emit err_nvim_get_vvar(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_VVAR:
		emit err_nvim_set_vvar(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_OPTION:
		emit err_nvim_get_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_ALL_OPTIONS_INFO:
		emit err_nvim_get_all_options_info(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_OPTION_INFO:
		emit err_nvim_get_option_info(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_OPTION:
		emit err_nvim_set_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_ECHO:
		emit err_nvim_echo(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_OUT_WRITE:
		emit err_nvim_out_write(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_ERR_WRITE:
		emit err_nvim_err_write(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_ERR_WRITELN:
		emit err_nvim_err_writeln(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_LIST_BUFS:
		emit err_nvim_list_bufs(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_CURRENT_BUF:
		emit err_nvim_get_current_buf(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_BUF:
		emit err_nvim_set_current_buf(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_LIST_WINS:
		emit err_nvim_list_wins(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_CURRENT_WIN:
		emit err_nvim_get_current_win(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_WIN:
		emit err_nvim_set_current_win(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_CREATE_BUF:
		emit err_nvim_create_buf(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_OPEN_TERM:
		emit err_nvim_open_term(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_CHAN_SEND:
		emit err_nvim_chan_send(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_OPEN_WIN:
		emit err_nvim_open_win(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_LIST_TABPAGES:
		emit err_nvim_list_tabpages(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_CURRENT_TABPAGE:
		emit err_nvim_get_current_tabpage(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_CURRENT_TABPAGE:
		emit err_nvim_set_current_tabpage(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_CREATE_NAMESPACE:
		emit err_nvim_create_namespace(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_NAMESPACES:
		emit err_nvim_get_namespaces(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_PASTE:
		emit err_nvim_paste(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_PUT:
		emit err_nvim_put(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SUBSCRIBE:
		emit err_nvim_subscribe(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_UNSUBSCRIBE:
		emit err_nvim_unsubscribe(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_COLOR_BY_NAME:
		emit err_nvim_get_color_by_name(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_COLOR_MAP:
		emit err_nvim_get_color_map(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_CONTEXT:
		emit err_nvim_get_context(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_LOAD_CONTEXT:
		emit err_nvim_load_context(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_MODE:
		emit err_nvim_get_mode(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_KEYMAP:
		emit err_nvim_get_keymap(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_KEYMAP:
		emit err_nvim_set_keymap(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_DEL_KEYMAP:
		emit err_nvim_del_keymap(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_COMMANDS:
		emit err_nvim_get_commands(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_API_INFO:
		emit err_nvim_get_api_info(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_CLIENT_INFO:
		emit err_nvim_set_client_info(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_CHAN_INFO:
		emit err_nvim_get_chan_info(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_LIST_CHANS:
		emit err_nvim_list_chans(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_CALL_ATOMIC:
		emit err_nvim_call_atomic(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_PARSE_EXPRESSION:
		emit err_nvim_parse_expression(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_LIST_UIS:
		emit err_nvim_list_uis(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_PROC_CHILDREN:
		emit err_nvim_get_proc_children(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_GET_PROC:
		emit err_nvim_get_proc(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SELECT_POPUPMENU_ITEM:
		emit err_nvim_select_popupmenu_item(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_SET_DECORATION_PROVIDER:
		emit err_nvim_set_decoration_provider(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_BUF:
		emit err_nvim_win_get_buf(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_BUF:
		emit err_nvim_win_set_buf(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_CURSOR:
		emit err_nvim_win_get_cursor(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_CURSOR:
		emit err_nvim_win_set_cursor(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_HEIGHT:
		emit err_nvim_win_get_height(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_HEIGHT:
		emit err_nvim_win_set_height(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_WIDTH:
		emit err_nvim_win_get_width(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_WIDTH:
		emit err_nvim_win_set_width(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_VAR:
		emit err_nvim_win_get_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_VAR:
		emit err_nvim_win_set_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_DEL_VAR:
		emit err_nvim_win_del_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_OPTION:
		emit err_nvim_win_get_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_OPTION:
		emit err_nvim_win_set_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_POSITION:
		emit err_nvim_win_get_position(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_TABPAGE:
		emit err_nvim_win_get_tabpage(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_NUMBER:
		emit err_nvim_win_get_number(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_IS_VALID:
		emit err_nvim_win_is_valid(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_SET_CONFIG:
		emit err_nvim_win_set_config(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_GET_CONFIG:
		emit err_nvim_win_get_config(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_HIDE:
		emit err_nvim_win_hide(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_CLOSE:
		emit err_nvim_win_close(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_CALL:
		emit err_nvim_win_call(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_LINE_COUNT:
		emit err_buffer_line_count(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_GET_LINES:
		emit err_buffer_get_lines(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_SET_LINES:
		emit err_buffer_set_lines(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_GET_VAR:
		emit err_buffer_get_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_GET_OPTION:
		emit err_buffer_get_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_SET_OPTION:
		emit err_buffer_set_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_GET_NAME:
		emit err_buffer_get_name(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_SET_NAME:
		emit err_buffer_set_name(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_IS_VALID:
		emit err_buffer_is_valid(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_GET_MARK:
		emit err_buffer_get_mark(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_ADD_HIGHLIGHT:
		emit err_buffer_add_highlight(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_COMMAND_OUTPUT:
		emit err_vim_command_output(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_GET_NUMBER:
		emit err_buffer_get_number(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_BUFFER_CLEAR_HIGHLIGHT:
		emit err_buffer_clear_highlight(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_TABPAGE_GET_WINDOWS:
		emit err_tabpage_get_windows(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_TABPAGE_GET_VAR:
		emit err_tabpage_get_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_TABPAGE_GET_WINDOW:
		emit err_tabpage_get_window(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_TABPAGE_IS_VALID:
		emit err_tabpage_is_valid(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_UI_DETACH:
		emit err_ui_detach(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_UI_TRY_RESIZE:
		emit err_ui_try_resize(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_COMMAND:
		emit err_vim_command(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_FEEDKEYS:
		emit err_vim_feedkeys(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_INPUT:
		emit err_vim_input(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_REPLACE_TERMCODES:
		emit err_vim_replace_termcodes(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_EVAL:
		emit err_vim_eval(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_CALL_FUNCTION:
		emit err_vim_call_function(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_STRWIDTH:
		emit err_vim_strwidth(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_LIST_RUNTIME_PATHS:
		emit err_vim_list_runtime_paths(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_CHANGE_DIRECTORY:
		emit err_vim_change_directory(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_CURRENT_LINE:
		emit err_vim_get_current_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_SET_CURRENT_LINE:
		emit err_vim_set_current_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_DEL_CURRENT_LINE:
		emit err_vim_del_current_line(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_VAR:
		emit err_vim_get_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_VVAR:
		emit err_vim_get_vvar(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_OPTION:
		emit err_vim_get_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_SET_OPTION:
		emit err_vim_set_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_OUT_WRITE:
		emit err_vim_out_write(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_ERR_WRITE:
		emit err_vim_err_write(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_REPORT_ERROR:
		emit err_vim_report_error(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_BUFFERS:
		emit err_vim_get_buffers(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_CURRENT_BUFFER:
		emit err_vim_get_current_buffer(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_SET_CURRENT_BUFFER:
		emit err_vim_set_current_buffer(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_WINDOWS:
		emit err_vim_get_windows(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_CURRENT_WINDOW:
		emit err_vim_get_current_window(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_SET_CURRENT_WINDOW:
		emit err_vim_set_current_window(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_TABPAGES:
		emit err_vim_get_tabpages(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_CURRENT_TABPAGE:
		emit err_vim_get_current_tabpage(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_SET_CURRENT_TABPAGE:
		emit err_vim_set_current_tabpage(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_SUBSCRIBE:
		emit err_vim_subscribe(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_UNSUBSCRIBE:
		emit err_vim_unsubscribe(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_NAME_TO_COLOR:
		emit err_vim_name_to_color(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_VIM_GET_COLOR_MAP:
		emit err_vim_get_color_map(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_GET_BUFFER:
		emit err_window_get_buffer(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_GET_CURSOR:
		emit err_window_get_cursor(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_SET_CURSOR:
		emit err_window_set_cursor(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_GET_HEIGHT:
		emit err_window_get_height(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_SET_HEIGHT:
		emit err_window_set_height(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_GET_WIDTH:
		emit err_window_get_width(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_SET_WIDTH:
		emit err_window_set_width(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_GET_VAR:
		emit err_window_get_var(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_GET_OPTION:
		emit err_window_get_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_SET_OPTION:
		emit err_window_set_option(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_GET_POSITION:
		emit err_window_get_position(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_GET_TABPAGE:
		emit err_window_get_tabpage(errMsg, res);
		break;
	case NeovimApi7::NEOVIM_FN_WINDOW_IS_VALID:
...
void NeovimApi7::handleResponse(quint32 msgid, quint64 fun, const QVariant& res)
{
	switch(fun) {
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_LINE_COUNT:
		{
	...
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_EXTMARK_BY_ID:
		{
			QList<int64_t> data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_buf_get_extmark_by_id");
				return;
			} else {
				emit on_nvim_buf_get_extmark_by_id(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_GET_EXTMARKS:
		{
			QVariantList data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_buf_get_extmarks");
				return;
			} else {
				emit on_nvim_buf_get_extmarks(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_SET_EXTMARK:
		{
			int64_t data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_buf_set_extmark");
				return;
			} else {
				emit on_nvim_buf_set_extmark(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_DEL_EXTMARK:
		{
			bool data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_buf_del_extmark");
				return;
			} else {
				emit on_nvim_buf_del_extmark(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_BUF_CALL:
		{
			QVariant data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_buf_call");
				return;
			} else {
				emit on_nvim_buf_call(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_UI_PUM_SET_BOUNDS:
		{
			emit on_nvim_ui_pum_set_bounds();
	...
	case NeovimApi7::NEOVIM_FN_NVIM_EXEC:
		{
			QByteArray data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_exec");
				return;
			} else {
				emit on_nvim_exec(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_GET_HL_ID_BY_NAME:
		{
			int64_t data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_get_hl_id_by_name");
				return;
			} else {
				emit on_nvim_get_hl_id_by_name(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_EXEC_LUA:
		{
			QVariant data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_exec_lua");
				return;
			} else {
				emit on_nvim_exec_lua(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_NOTIFY:
		{
			QVariant data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_notify");
				return;
			} else {
				emit on_nvim_notify(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_GET_RUNTIME_FILE:
		{
			QList<QByteArray> data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_get_runtime_file");
				return;
			} else {
				emit on_nvim_get_runtime_file(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_GET_ALL_OPTIONS_INFO:
		{
			QVariantMap data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_get_all_options_info");
				return;
			} else {
				emit on_nvim_get_all_options_info(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_GET_OPTION_INFO:
		{
			QVariantMap data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_get_option_info");
				return;
			} else {
				emit on_nvim_get_option_info(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_OPEN_TERM:
		{
			int64_t data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_open_term");
				return;
			} else {
				emit on_nvim_open_term(data);
			}
	...
	case NeovimApi7::NEOVIM_FN_NVIM_SET_DECORATION_PROVIDER:
		{
			emit on_nvim_set_decoration_provider();
	...
	case NeovimApi7::NEOVIM_FN_NVIM_WIN_CALL:
		{
			QVariant data;
			if (decode(res, data)) {
				m_c->setError(NeovimConnector::RuntimeMsgpackError, "Error unpacking return type for nvim_win_call");
				return;
			} else {
				emit on_nvim_win_call(data);
			}
 ...
 */
bool NeovimApi7::checkFunctions(const QVariantList& ftable)
{
	...
	required
		...
		<< Function("void", "nvim_buf_set_lines",
			QList<QString>()
						...
						, false)
		<< Function("void", "nvim_buf_set_text",
			QList<QString>()
						<< QStringLiteral("Buffer")
						<< QStringLiteral("Integer")
						<< QStringLiteral("Integer")
		...
		<< Function("ArrayOf(Integer, 2)", "nvim_buf_get_mark",
			QList<QString>()
						...
						<< QStringLiteral("String")
						, false)
		<< Function("ArrayOf(Integer)", "nvim_buf_get_extmark_by_id",
			QList<QString>()
						<< QStringLiteral("Buffer")
						<< QStringLiteral("Integer")
						<< QStringLiteral("Integer")
						<< QStringLiteral("Dictionary")
						, false)
		<< Function("Array", "nvim_buf_get_extmarks",
			QList<QString>()
						<< QStringLiteral("Buffer")
						<< QStringLiteral("Integer")
						<< QStringLiteral("Object")
						...
						<< QStringLiteral("Dictionary")
						, false)
		<< Function("Integer", "nvim_buf_set_extmark",
			QList<QString>()
						<< QStringLiteral("Buffer")
						<< QStringLiteral("Integer")
						<< QStringLiteral("Integer")
						...
						<< QStringLiteral("Dictionary")
						, false)
		<< Function("Boolean", "nvim_buf_del_extmark",
			QList<QString>()
						<< QStringLiteral("Buffer")
						<< QStringLiteral("Integer")
						<< QStringLiteral("Integer")
		...
		<< Function("void", "nvim_ui_pum_set_height",
			QList<QString>()
						<< QStringLiteral("Integer")
						, false)
		<< Function("void", "nvim_ui_pum_set_bounds",
			QList<QString>()
		...
		<< Function("Dictionary", "nvim_get_hl_by_id",
			QList<QString>()
						...
						<< QStringLiteral("Boolean")
						, false)
		<< Function("Integer", "nvim_get_hl_id_by_name",
			QList<QString>()
						<< QStringLiteral("String")
						, false)
		<< Function("void", "nvim_set_hl",
			QList<QString>()
						<< QStringLiteral("Integer")
						<< QStringLiteral("String")
						<< QStringLiteral("Dictionary")
		...
		<< Function("Object", "nvim_eval",
			QList<QString>()
						<< QStringLiteral("String")
						, false)
		<< Function("Object", "nvim_exec_lua",
			QList<QString>()
						<< QStringLiteral("String")
						<< QStringLiteral("Array")
						, false)
		<< Function("Object", "nvim_notify",
			QList<QString>()
						<< QStringLiteral("String")
						<< QStringLiteral("Integer")
						<< QStringLiteral("Dictionary")
		...
		<< Function("ArrayOf(String)", "nvim_list_runtime_paths",
			QList<QString>()
						, false)
		<< Function("ArrayOf(String)", "nvim_get_runtime_file",
			QList<QString>()
						<< QStringLiteral("String")
						<< QStringLiteral("Boolean")
						, false)
		...
		<< Function("Object", "nvim_get_option",
			QList<QString>()
						<< QStringLiteral("String")
						, false)
		<< Function("Dictionary", "nvim_get_all_options_info",
			QList<QString>()
						, false)
		<< Function("Dictionary", "nvim_get_option_info",
			QList<QString>()
						<< QStringLiteral("String")
						, false)
		...
		<< Function("Buffer", "nvim_create_buf",
			QList<QString>()
						...
						<< QStringLiteral("Boolean")
						, false)
		<< Function("Integer", "nvim_open_term",
			QList<QString>()
						<< QStringLiteral("Buffer")
						<< QStringLiteral("Dictionary")
						, false)
		<< Function("void", "nvim_chan_send",
			QList<QString>()
						<< QStringLiteral("Integer")
						<< QStringLiteral("String")
						, false)
		...
		<< Function("void", "nvim_select_popupmenu_item",
			QList<QString>()
						...
						<< QStringLiteral("Dictionary")
						, false)
		<< Function("void", "nvim_set_decoration_provider",
			QList<QString>()
						<< QStringLiteral("Integer")
						<< QStringLiteral("Dictionary")
						, false)
	...
	foreach(const QVariant& val, ftable) {
		...
		if (!required.contains(f)) {
			qDebug() << "Unknown function(api 7)" << f;
		}
	}
	...
	foreach(const Function& f, required) {
		if (!supported.contains(f)) {
			qDebug() << "- instance DOES NOT support API7:" << f;
			ok = false;
		}
	}
	return ok;
