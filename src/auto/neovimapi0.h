// Auto generated 2021-07-31 13:15:06.488178 from nvim API level:0
#pragma once
...
public slots:
	...
	NeovimQt::MsgpackRequest* vim_command(QByteArray str) noexcept;
	...
	NeovimQt::MsgpackRequest* vim_eval(QByteArray str) noexcept;
