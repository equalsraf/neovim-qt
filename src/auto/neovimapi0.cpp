...
NeovimApi0::NeovimApi0(NeovimConnector* c): m_c(c)
{
	...
	connect(m_c->m_dev, &MsgpackIODevice::notification, this, &NeovimApi0::neovimNotification);
}
...
MsgpackRequest* NeovimApi0::buffer_get_line_slice(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest* NeovimApi0::buffer_get_lines(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest* NeovimApi0::buffer_set_line_slice(int64_t buffer, int64_t start, int64_t end,
												  bool include_start, bool include_end,
...
MsgpackRequest* NeovimApi0::buffer_set_lines(int64_t buffer, int64_t start, int64_t end,
...
MsgpackRequest* NeovimApi0::buffer_clear_highlight(int64_t buffer, int64_t src_id,
...
MsgpackRequest* NeovimApi0::vim_replace_termcodes(QByteArray str, bool from_part, bool do_lt,
												  bool special)
{
